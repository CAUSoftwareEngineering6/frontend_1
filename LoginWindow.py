...
class GroupSelectWindow(QWidget):
    ...
    def go_to_notice(self):
        self.notice_window = GroupDetailWindow(self.group, self.main_window, 'notice')
        self.main_window.setCentralWidget(self.notice_window)

    def go_to_discussion(self):
        self.discussion_window = GroupDetailWindow(self.group, self.main_window, 'discussion')
